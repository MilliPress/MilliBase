...
The `field` object contains all [client-safe properties](../02-usage/02-schema-definition.md#common-properties): `key`, `type`, `label`, `default`, `tooltip`, `placeholder`, `min`, `max`, `options`, `units`, `save`, etc.
